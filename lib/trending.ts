...
const baseUrl = `https://indexer.crossbell.io/v1/characters/${process.env.NEXT_PUBLIC_CHARCTER_ID || defaultCharacterID}/feed/follow`;
...
async function getTrendingNotes({
  ...
  includeCharacterMetadata?: string;
    ...
    url.searchParams.append("includeCharacterMetadata", includeCharacterMetadata);
  }
